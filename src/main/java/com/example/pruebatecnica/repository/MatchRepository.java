...
public interface MatchRepository extends MongoRepository<Match, String> {
    ...
    @Aggregation(pipeline =      {
            "{ '$match': { 'tournamentId': '6798eab9fb07c04a10beb2f1' } }",
            ...
            "{ '$lookup': { 'from': 'tournaments', 'let': { 'teamId': '$_id' }, 'pipeline': [{ '$addFields': { 'tournamentIdStr': { '$toString': '$_id' } } }, { '$match': { '$expr': { '$eq': ['$tournamentIdStr', '6798eab9fb07c04a10beb2f1'] } } }, { '$unwind': '$teams' }, { '$match': { '$expr': { '$eq': ['$teams._id', '$$teamId'] } } }, { '$project': { 'teamName': '$teams.name' } }], 'as': 'teamData' } }",
